        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12"> 
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.driver.update', $data->id) }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <x-input-field name="username" id="username" label="Username" value="{{ $data->username}}"/>
                                        <x-input-field name="hp" id="hp" label="No HP/Wa" value="{{ $data->hp}}"/>
