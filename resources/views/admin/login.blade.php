...
<body class="login-page bg-body-secondary">
    <div class="login-box">
        <div class="card card-outline card-primary overflow-hidden rounded-3">
            <div class="card-header"> 
                <a href="{{ route('admin.login') }}" class="link-dark text-center text-decoration-none">
                    <h1 class="fs-4 fw-bold mb-0">ARWINDO GHANI UTAMA</h1>
                </a>
            </div>
