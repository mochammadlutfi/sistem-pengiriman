...
class DriverController extends Controller
{
    ...
    {
        $data = User::where('level', 'Driver')->orderBy('id', 'DESC')->get();
        // dd($data);
    ...
    {
        $data = User::where('level', 'Driver')->where('id', $id)->first();
    ...
    public function peserta($id, Request $request)
    {
            ...
            return DataTables::of($query)
                ...
                ->addColumn('action', function($row){
                    $btn = '<div class="dropdown">
                        ...
                        $btn .= '<a class="dropdown-item" href="'. route('admin.driver.edit', $row->id).'"><i class="si si-note me-1"></i>Ubah</a>';
        ...
        return view('admin.driver.peserta',[
            'data' => $data,
            'user' => $user
        ]);
    }
